...
| Category | Score |
| -------- | ----- |
${scoreRow('Performance', summary.performance)} (prev ${prevScores[0].summary.perfomance} )}
${scoreRow('Accessibility', summary.accessibility)} (prev ${prevScores[0].summary.accessibility} )}
